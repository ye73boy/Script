...
const inviteCodes = [
  `ak4wb77tLw@eU9YDpLBE6tVuRCBqg9o`,
  ,
]
if ($.isNode()) {
...
!(async () => {
  ...
  await requireConfig()
  $.authorCode = await getAuthorShareCode('https://raw.githubusercontent.com/ye73boy/updateTeam/main/shareCodes/updateCash.json')
  if (!$.authorCode) {
    $.http.get({url: 'https://cdn.jsdelivr.net/gh/ye73boy/updateTeam@main/shareCodes/updateCash.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.authorCode = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/ye73boy/updateTeam@main/shareCodes/updateCash.json') || []
  }
